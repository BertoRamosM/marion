...
const About = () => {
  ...
  return (
    <div
      id="about"
      className="flex flex-col lg:flex-row items-center justify-center gap-8 px-0 sm:px-6 pt-8 pb-16 text-pretty"
    >
      {/*
        Text card.
      ...
      */}
      <div className="sm:max-w-lg bg-[#fff7f3] p-8 rounded-3xl shadow-lg z-10">
        <h2 className="text-3xl font-bold text-[#d24b06] text-pretty">
          {t("text1")}
        </h2>

        {/* space-y-4 instead of <br> tags: consistent rhythm, and every
            paragraph is a real <p> so the text has proper structure. */}
        <div className="pt-4 space-y-4 text-gray-800">
          <p className="font-bold text-[#006a8f]">{t("text2")}</p>
          <p>{t("text3")}</p>
          <p>{t("text4")}</p>
          <p>{t("text5")}</p>
          <p>{t("text6")}</p>
